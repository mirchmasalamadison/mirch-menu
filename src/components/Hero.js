  ...
  return (
    <section style={sectionStyle} className="hero-section">
      <div className="hero-content-container">
        ...
        <h3 className="hero-subtitle">Award Winning Indian Cuisine</h3>
        ...
        <p className="hero-description">
          Located in Madison, WI, we serve award winning South Asian Cuisine{" "}
          <strong>bursting with fabulous flavors!</strong> <br />
          Come enjoy a savory culinary experience today or call us for takeout.
          <br />
          <br />
        </p>
        <Link href="tel:(608) 203-5387" className="hero-phone-container">
          <p className="hero-phone-number">(608) 203-5387 </p>{" "}
          <MdPhonelinkRing fontSize={36} className="phone-icon" />
        </Link>
        ...
        <div className="hero-buttons">
          ...
          <div className="hero-btn-container">
            <Link href="tel:(608) 203-5387">
              <button className="hero-phone btn">Call Us</button>
            </Link>
          </div>
          <div className="hero-btn-container">
